...
def _get_detail_i18n_block():
    """Return i18n HTML/CSS/JS block for detail pages"""
    return '''
<!-- i18n patch -->
<style>
...
else{let txt=origS||sub.textContent;for(const[jk,ev] of Object.entries(t.wl)){txt=txt.replace(new RegExp(jk,'g'),ev);}sub.textContent=txt;}}
